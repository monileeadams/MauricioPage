...
`, 
  ...
  { 
    ...
    content: `<blockquote>«La ruina es el destino hacia el cual todos los hombres se apresuran, cada uno persiguiendo su propio interés en una sociedad que cree en la libertad de los bienes comunes. La libertad en un bien de uso común trae ruina a todos». Fragmento del ensayo, «La tragedia de los comunes» publicado en 1969 por Garret Hardin.</blockquote>
...
<img src="/images/discriminacion1.jpg" alt="Protesta ambiental" class="my-6 rounded-lg shadow-md" />
...
<img src="/images/discriminacion2.jpg" alt="Congreso" class="my-6 rounded-lg shadow-md" />
...
<img src="/images/Discriminacion3.jpeg" alt="Gráficos de datos" class="my-6 rounded-lg shadow-md" />
<p><em>Fotografía: Mauricio de la Maza-Benignos</em></p>
